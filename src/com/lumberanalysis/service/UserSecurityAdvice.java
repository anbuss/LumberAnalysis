 ...
 */
public class UserSecurityAdvice implements MethodBeforeAdvice, AfterReturningAdvice, Serializable {
    ...
    private final Logger log = Logger.getLogger(UserSecurityAdvice.class);
